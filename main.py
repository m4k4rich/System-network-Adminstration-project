...
app = FastAPI()
templates = Jinja2Templates(directory="filesDirectory")
user_names = []
user_files = {}
client = ""
def connect_to_db():
...
async def handle_form(username: str = Form(...), newFiles: List[UploadFile] = File(...)):
    ...
    returnPage = open("filesDirectory/filesSubmitted.html", 'r')
